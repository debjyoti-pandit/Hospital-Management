...
?>
              ...
              <div class="col-lg-12">
                <div class="header-icon"><i class="fa fa-globe" aria-hidden="true"></i></div>
                  <div class="header-title">
                    ...
                    <small>Add Operation Report</small>
                  </div>
              </div>
            </div>
        ...
        <div class="row" style="padding: 10px;">
          <div class="col-sm-12 mbutton">
            <a href="operation-report-list.php"><input type="submit" class="myButton" size="180px" value="Operation Report List"></a>
          </div>    
        </div>
        <div class="row" style="padding-top:5px;margin-right: 40px;">
          <form class="form-horizontal">
              <div class="form-group">
                  ...
                  <div class="form-group">
                  <label for="dob" class="col-sm-2 control-label">Date Of Operation</label>
                    <div class="col-sm-10">
    ...
    $(document).ready(function(){
      $('#add-doc-btn').click(function(){
        //if(d){
          ...
          $.post("add-operation-report-submit.php",{"name":name,"doctor":doctor,"title":title,"description":description,"sex":sex,"dob":dob,"status":status},function(data){
              alert(data);
              $("#name").val("");
              $("#doctor").val("");
              $("#title").val("");
