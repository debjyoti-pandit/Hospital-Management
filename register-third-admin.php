          ...
          if(d){
              ...
              var blood_group=document.getElementById("blood_group").value;
                  $.get("xxx.php",function(data){
                    ...
                    $.post("register-admin.php",{"email":email,"password":password,"firstname":firstname,"sex":sex,"lastname":lastname,"address":address,"dob":dob,"phone":phone,"mobile":mobile,"blood_group":blood_group},function(data){
                       //
