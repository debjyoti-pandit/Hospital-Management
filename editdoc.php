...
<body id="body" style="margin-top: 0px; overflow-x: hidden;">
  <div id="wrapper">
    ...
    <!-- container-->
    <div id="page-content-wrapper" style="height:1300px;">
      <div class="container-fluid">
        ...
        <?php
		      $id=$_GET['id'];
			    ...
			    $str="select * from doctor where id=$id";
			    $result=mysqli_query($con,$str);
			    $row=mysqli_fetch_array($result,MYSQLI_ASSOC);
		    ?>

        <div class="row" style="padding-top:5px;margin-right: 40px;">
          <form class="form-horizontal" action="modifydoc.php" method="GET">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <label for="mobile" class="col-sm-2 control-label">Mobile Number</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="mobile" name="mobile" readonly  value="<?php echo $row['mobile']?>">
                    </div>
                </div>
                <div class="form-group">
                  <label for="Phone" class="col-sm-2 control-label">Phone Number</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="phone" name="phone" readonly  value="<?php echo $row['phone']?>">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="dob" class="col-sm-2 control-label">D.O.B.</label>
                    <div class="col-sm-10">
                      <input type="date" class="form-control" id="dob" name="dob"  readonly value="<?php echo $row['dob']?>" />
                    </div>
                </div>
                 <div class="form-group">
                    <label for="blood_group" class="col-sm-2 control-label">Blood Group</label>
                    <div class="col-sm-10">
                      <select id="blood_group"  readonly name="blood_group" class="form-control">
                        <?php
                ...
                <div class="form-group">
                  <label for="address" class="col-sm-2 control-label">Address</label>
                    <div class="col-sm-10">
                      <textarea rows="3" readonly  class="form-control" id="address" style="padding-left:5px;" name="address"><?php echo $row['address']?></textarea>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="depertment" class="col-sm-2 control-label">Department</label>
                    <div class="col-sm-10">
                      <select id="department" name="department" class="form-control">
                        <?php
                          ...
                          $str2="select dname from department order by dname;";
                ...
                <div class="form-group">
                  <label for="specialist" class="col-sm-2 control-label">Specialist</label>
                    <div class="col-sm-10">
                      <input type="text"  readonly class="form-control" id="specialist" name="specialist" value="<?php echo $row['specialist']?>">
                    </div>
                </div>
                <div class="form-group">
                  <label for="qualification" class="col-sm-2 control-label">Qualification</label>
                    <div class="col-sm-10">
                      <textarea rows="3"  readonly class="form-control" id="qualification" name="qualification" style="padding-left:5px;"><?php echo $row['qualification']?></textarea>
                    </div>
                </div>
                <div class="form-group">
                  <label for="doj" class="col-sm-2 control-label">D.O.J.</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                          ...
                          <input type="submit" id="add-doc-btn" value="Update" name="btnud" class="btn btn1 cursor"  style="vertical-align: baseline;">
